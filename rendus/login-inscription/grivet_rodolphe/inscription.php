...
<body>
	...
	<form action="#" method="POST">
		...
		<input type="text" name="nom" id="nom" placeholder="Ton nom" >
		<br>
		<label for="age">Age :</label>
		<input type="number" name="age" id="age" placeholder="Ton age">
		<br>
		<label for="mail">Mail :</label>
		<input type="text" name="mail" id="mail" placeholder="Ton Email">
		<br>
		<label for="pass">Password :</label>
		<input type="password" name="password" id="pass" placeholder="Ton password">
		<br>
		<label for="pass2">Repet password :</label>
		<input type="password" name="password2" id="pass2" placeholder="Ton password">
		<br>
		<input type="submit">
	</form>
